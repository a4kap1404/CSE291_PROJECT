...
export VERILOG_FILES = $(DESIGN_HOME)/src/swerv/swerv_wrapper.sv2v.v $(DESIGN_HOME)/$(PLATFORM)/swerv/macros.v
...
export ADDITIONAL_LIBS = $(PLATFORM_DIR)/lib/fakeram45_2048x39.lib $(PLATFORM_DIR)/lib/fakeram45_256x34.lib $(PLATFORM_DIR)/lib/fakeram45_64x21.lib
